...
class Distance_Request(metaclass=Metaclass_Distance_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.theda = kwargs.get('theda', float())
    ...
    @theda.setter
    def theda(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'theda' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'theda' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._theda = value
